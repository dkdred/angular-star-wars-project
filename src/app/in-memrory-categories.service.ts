...
export class InMemoryCategoriesService implements InMemoryDbService{
  createDb(): object {
    const categories = [
      { title: 'Персонажи', backgroundImg: 'https://starwars-visualguide.com/assets/img/categories/character.jpg', subTitle: 'Список популярных героев «Звёздных войны»', link: '/list/people' },
